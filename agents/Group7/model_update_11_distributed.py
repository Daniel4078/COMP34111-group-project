...
for episode in range(num_episodes):
    ...
    for move_num in range(len(States) - 1, -1, -1):
        ...
        # Store x,y to the overall list
        total_states1.append(States[move_num])
        total_Q1.append(Q_values)
    ...
    for move_num in range(len(illegal_states)):
        ...
        # Store x,y to the overall list
        total_states1.append(illegal_states[move_num])
        total_Q1.append(Q_values)
    ...
    for move_num in range(len(States2) - 1, -1, -1):
        ...
        # Store x,y to the overall list
        total_states2.append(States2[move_num])
        total_Q2.append(Q_values)
    ...
    for move_num in range(len(illegal_states2)):
        ...
        # Store x,y to the overall list
        total_states2.append(illegal_states2[move_num])
        total_Q2.append(Q_values)
